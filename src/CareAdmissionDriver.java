...
public class CareAdmissionDriver {
     ...
     *
     */
    public CareAdmissionDriver(int capacity) throws IllegalArgumentException{
        if(capacity < 0){
        ...
        if (commands.length < 4) {
            ...
            try {
                ...
                if (commands[2].length() != 1) {
                    System.out.println(SYNTAX_ERROR_MSG
                            + " Gender can be M (for Male), F (for Female), or X (for Other), " +
                            "only.");
                } else {
                ...
                System.out
                        .println(SYNTAX_ERROR_MSG + " Invalid triage level! Should be either " +
                                "RED/YELLOW/GREEN");
            }
        }
            ...
            try {
                switch (command.charAt(0)) {
                    ...
                    case '6': // [6] Clear the Care Admission Queue
                        System.out.println("Sorry! We are closed due to out of control " +
                                "circumstances!");
                        queue.clear();
                        break;
                    default:
